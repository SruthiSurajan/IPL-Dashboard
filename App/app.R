...
ui <- dashboardPage(skin = "black",
  ...
  dashboardSidebar( 
                    sidebarMenu(
                      ...
                      menuItem("Winning Regression",tabName = "regression",icon = icon("glyphicon glyphicon-link", lib = "glyphicon"))
    ...
    tabItems(
              ...
              fluidRow(
                shinydashboard::box(width = 12, background = 'black',
                                    ...
                                    valueBox(tags$p('Rajasthan Royals (RR)', style = 'font-size: 30%;text-align: center;'), 
                                             div(img(src = 'rr.png', height = '120', width = '160'),style='text-align: center;'), 
                                             icon = NULL, width = 2, color = 'black'),
      ...
      tabItem(tabName = 'summary',
              ...
              shinydashboard::box(title = 'IPL Season Winners List',
                                  ...
                                  collapsed = T,
                                  fluidRow(
                                    valueBox(tags$p('2008', style = 'font-size: 40%;text-align: center;'), div(img(src = 'rr.png', height = '80', width = '100'),style='text-align: center;'), 
                                             icon = NULL, width = 2, color = 'black'),
              ...
              shinydashboard::box(title = 'Orange Cap Winners List',
                                  ...
                                  shinydashboard::box( background  = 'black',width = 12,
                                                       ...
                                                       valueBox(tags$p('2010 -  Sachin Tendulkar (MI)', style = 'font-size: 30%;text-align: center;'), div(img(src = "sachin.png", 
                                                                                                                                                               height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2011 - Chris Gayle (RCB)', style = 'font-size: 30%;text-align: center;'), div(img(src = "gayle.png", 
                                                                                                                                                          height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2012 - Chris Gayle (RCB)', style = 'font-size: 30%;text-align: center;'), div(img(src = "gayle.png", 
                                                                                                                                                          height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),                                                                                              
                                                       valueBox(tags$p('2013 - Michael Hussey (CSK)', style = 'font-size: 30%;text-align: center;'), div(img(src = "hussey.png",
                                                                                                                                                             height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2014 - Robin Uthappa (KKR)', style = 'font-size: 30%;text-align: center;'), div(img(src = "uttappa.png", 
                                                                                                                                                            height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2015 - David Warner (SRH)', style = 'font-size: 30%;text-align: center;'), div(img(src = "warner.png", 
                                                                                                                                                           height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2016 - Virat Kohli (RCB)', style = 'font-size: 30%;text-align: center;'), div(img(src = "kohili.png", 
                                                                                                                                                          height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2017 - David Warner (SRH)', style = 'font-size: 30%;text-align: center;'), div(img(src = "warner.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p('2018 - Kane Williamson (SRH)', style = 'font-size: 30%;text-align: center;'), div(img(src = "wiliamson.png", 
                                                                                                                                                              height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2019 - David Warner (SRH)', style = 'font-size: 30%;text-align: center;'), div(img(src = "warner.png", 
                                                                                                                                                           height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'))
              ),
              ...
              shinydashboard::box(title = 'Purple Cap Winners List',
                                  ...
                                  shinydashboard::box( background  = 'black',width = 12,
                                                       ...
                                                       valueBox(tags$p("2012 - Morne Morkel (DD)", style = "font-size: 30%;text-align: center;"), div(img(src = "B5.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2013 - Dwayne Bravo (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "B6.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2014 - Mohit Sharma (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "B7.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2015 - Dwayne Bravo (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "B6.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       ...
                                                       valueBox(tags$p("2017 - Bhuvneshwar Kumar (SRH)", style = "font-size: 30%;text-align: center;"), div(img(src = "B8.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2018 - Andrew Tye (KXIP)", style = "font-size: 30%;text-align: center;"), div(img(src = "B9.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
